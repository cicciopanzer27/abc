...
\item \textbf{Statistical robustness:} Mean $\rho$ across all datasets: $0.790410 \pm 0.083960$ (std of means), range $[0.706235, 0.905023]$. This high consistency (std of means $< 0.1$) confirms that results are statistically representative and not artifacts of small sample size. The framework remains valid (K $\geq$ 1) in 100\% of all cases across all datasets.
\end{itemize}
